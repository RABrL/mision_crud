                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" id='frmLogin'>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="username" name='username' aria-describedby="emailHelp" placeholder="Nick name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" onclick="frmLogin(event)" type="submit">
                                            Login
                                        </button>
                                        <hr>
                                    </form>
